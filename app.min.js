...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_get_youtube_id__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_get_youtube_id___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_get_youtube_id__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vimeo_regex__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vimeo_regex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vimeo_regex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_js_video_url_parser__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_js_video_url_parser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_js_video_url_parser__);
...
const matchers = {
  youtube: {
    matcher: /youtu\.?be/,
    process: __WEBPACK_IMPORTED_MODULE_0_get_youtube_id___default.a,
  },
  vimeo: {
    matcher: /vimeo.com/,
    process: url => __WEBPACK_IMPORTED_MODULE_1_vimeo_regex___default()().exec(url)[4],
  },
  dailymotion: {
    matcher: /dailymotion.com/,
    process: url => __WEBPACK_IMPORTED_MODULE_2_js_video_url_parser___default.a.parse(url).id,
  },
}
/* harmony export (immutable) */ __webpack_exports__["a"] = matchers;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = processUrl;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_youtube_iframe__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_youtube_iframe___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_youtube_iframe__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vimeo_player__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vimeo_player___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__vimeo_player__);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_preact__["Component"] {
  ...
  componentDidMount() {
    ...
    for (const player in __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* matchers */]) {
  ...
  youtubePlayerInit() {
    ...
    __WEBPACK_IMPORTED_MODULE_2_youtube_iframe___default.a.load(YT => {
  ...
  vimeoPlayerInit() {
    ...
    this.vimeoPlayerAPI = new __WEBPACK_IMPORTED_MODULE_3__vimeo_player___default.a(playerElement, { id: 59777392 });
  ...
  playNext() {
    ...
    for (let i = 0; i < this.state.urls.length; i++) {
      if (this.state.urls[i] === this.state.currentUrl) {
        ...
        if (url) {
          const potentialCurrentUrl = __WEBPACK_IMPORTED_MODULE_4__utils__["b" /* processUrl */](url);
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.div([
      (this.state.playersReady || 0) < Object.keys(__WEBPACK_IMPORTED_MODULE_4__utils__["a" /* matchers */]).length
      ? 'Loading players...'
      : __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.form({ onsubmit: e => this.play() }, [
        __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.textarea({
        ...
        __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.button('Play'),
      ]),
      __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.pre(JSON.stringify(this.state.urls, null, 2)),
      this.state.status && __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.pre('Status: ' + this.state.status),
      this.state.error && __WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default.a.pre('Error: ' + this.state.error),
    ]);
  }
}

__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["render"])(__WEBPACK_IMPORTED_MODULE_1_preact_hyperscript_h___default()(App), document.getElementById('app'));
...
var createHelpers = __webpack_require__(10)
...
var hyphenate = __webpack_require__(7)
